...
| `upscale/sprite_region_not_left_stale` | a sprite's own pass paints its whole region, so the frame's earlier composite of the picture before the sprite drew cannot survive at its rounded edges |
